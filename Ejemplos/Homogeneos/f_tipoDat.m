...
switch seccion
   ...
   case 'VelocidadFiltracion_Vy_n+theta_del_elemento'
    ...
    case 'VelocidadFiltracion_T3_del_elemento'
      tipoDat1 = str2double(f_ProxString_Curva(fId)); 
      f_ProxString_Curva(fId);
      tipoDat3 = str2double(f_ProxString_Curva(fId));
      tipoDat = ['Velocidad de Filtracion T3 del_elemento ',num2str(tipoDat1),' y del punto de gauss ','',num2str(tipoDat3)];
   case 'VelocidadFiltracion_T4_del_elemento'
      tipoDat1 = str2double(f_ProxString_Curva(fId)); 
      f_ProxString_Curva(fId);
      tipoDat3 = str2double(f_ProxString_Curva(fId));
      tipoDat = ['Velocidad de Filtracion T4 del_elemento ',num2str(tipoDat1),' y del punto de gauss ','',num2str(tipoDat3)];
   case 'VelocidadFiltracion_T5_del_elemento'
      tipoDat1 = str2double(f_ProxString_Curva(fId)); 
      f_ProxString_Curva(fId);
      tipoDat3 = str2double(f_ProxString_Curva(fId));
      tipoDat = ['Velocidad de Filtracion T5 del_elemento ',num2str(tipoDat1),' y del punto de gauss ','',num2str(tipoDat3)];
   case 'VelocidadFiltracion_Vy_sta_del_elemento'
      tipoDat1 = str2double(f_ProxString_Curva(fId)); 
      f_ProxString_Curva(fId);
      tipoDat3 = str2double(f_ProxString_Curva(fId));
      tipoDat = ['Velocidad de Filtracion V_sta del_elemento ',num2str(tipoDat1),' y del punto de gauss ','',num2str(tipoDat3)];
   case 'VelocidadFiltracion_Vy_dyn_del_elemento'
      tipoDat1 = str2double(f_ProxString_Curva(fId)); 
      f_ProxString_Curva(fId);
      tipoDat3 = str2double(f_ProxString_Curva(fId));
      tipoDat = ['Velocidad de Filtracion V_dyn del_elemento ',num2str(tipoDat1),' y del punto de gauss ','',num2str(tipoDat3)];
