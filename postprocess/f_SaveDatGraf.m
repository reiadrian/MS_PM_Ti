...
%                   m_Dat(iEje) = tens(5,pg,m_IndElemSet);
               ...
               case 'Vy_dyn'
                  ...
                  npg = e_DatSet(set).e_DatElem.npg;
                  m_IndElemSet = e_DatSet(set).m_IndElemSet==elem;
                  vel = reshape(e_VarEst(set).velflu_dyn,nvel,npg,[]);
                  m_Dat(iEje) = vel(2,pg,m_IndElemSet);
               case 'Vy_sta'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  pg = m_DatGrafXY(iGraf,iEje+4);
                  ...
                  npg = e_DatSet(set).e_DatElem.npg;
                  m_IndElemSet = e_DatSet(set).m_IndElemSet==elem;
                  vel = reshape(e_VarEst(set).velflu_n1,nvel,npg,[]);
                  m_Dat(iEje) = vel(2,pg,m_IndElemSet);
               case 'T3'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  pg = m_DatGrafXY(iGraf,iEje+4);
                  ...
                  npg = e_DatSet(set).e_DatElem.npg;
                  m_IndElemSet = e_DatSet(set).m_IndElemSet==elem;
                  vel = reshape(e_VarEst(set).T3,nvel,npg,[]);
                  m_Dat(iEje) = vel(2,pg,m_IndElemSet);
               case 'T4'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  pg = m_DatGrafXY(iGraf,iEje+4);
                  ...
                  npg = e_DatSet(set).e_DatElem.npg;
                  m_IndElemSet = e_DatSet(set).m_IndElemSet==elem;
                  vel = reshape(e_VarEst(set).T4,nvel,npg,[]);
                  m_Dat(iEje) = vel(2,pg,m_IndElemSet);
               case 'T5'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  pg = m_DatGrafXY(iGraf,iEje+4);
                  ...
                  npg = e_DatSet(set).e_DatElem.npg;
                  m_IndElemSet = e_DatSet(set).m_IndElemSet==elem;
                  vel = reshape(e_VarEst(set).T5,nvel,npg,[]);
                  m_Dat(iEje) = vel(2,pg,m_IndElemSet);
               case 'chi'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  pg = m_DatGrafXY(iGraf,iEje+4);
