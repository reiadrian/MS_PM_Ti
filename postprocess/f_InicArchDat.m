...
%                      fclose(fId);
            ...
            switch conshyp
               case {50,51,60,61} %Modelo multiescala cl�sico y cohesivo
...
%       'Da','DisGLO','Ehxx','Ehyy','Ehzz','Ehxy','Shxx','Shyy','Shzz','Shxy','Snn','Snt','p','q'}; %JLM
   c_NomDat = {'T','Dx','Dy','Dz','Fx','Fy','Fz','Bx','By','Bz','Tx','Ty','Tz',...
      ...
      'Vx','Vy','Vx_n+theta','Vy_n+theta','chi','Vy_dyn','T3','T4','T5','Vy_sta'}; %JLM %AA:logT
      ...
      for iGraf = 1:nGraf         
         for iEje = 1:2
           ...
           case 'Vy_dyn'
                  ...
                  set = m_SetElem(elem);
                  elem = e_DatSet(set).m_NumElem(e_DatSet(set).m_IndElemSet==elem);
                  c_TextoEjes{iEje} = ['VelocidadFiltracion_Vy_dyn_del_elemento ',int2str(elem),...
                     ' y_del_punto_de_gauss ',int2str(pg)];
           case 'Vy_sta'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  f_VerifInfoGraf(elem,'elemento',c_TextTipoEjeGraf{iEje},iGraf);
                  ...
                  set = m_SetElem(elem);
                  elem = e_DatSet(set).m_NumElem(e_DatSet(set).m_IndElemSet==elem);
                  c_TextoEjes{iEje} = ['VelocidadFiltracion_Vy_sta_del_elemento ',int2str(elem),...
                     ' y_del_punto_de_gauss ',int2str(pg)];
             case 'T3'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  f_VerifInfoGraf(elem,'elemento',c_TextTipoEjeGraf{iEje},iGraf);
                  ...
                  set = m_SetElem(elem);
                  elem = e_DatSet(set).m_NumElem(e_DatSet(set).m_IndElemSet==elem);
                  c_TextoEjes{iEje} = ['VelocidadFiltracion_T3_del_elemento ',int2str(elem),...
                     ' y_del_punto_de_gauss ',int2str(pg)];
              case 'T4'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  f_VerifInfoGraf(elem,'elemento',c_TextTipoEjeGraf{iEje},iGraf);
                  ...
                  set = m_SetElem(elem);
                  elem = e_DatSet(set).m_NumElem(e_DatSet(set).m_IndElemSet==elem);
                  c_TextoEjes{iEje} = ['VelocidadFiltracion_T4_del_elemento ',int2str(elem),...
                     ' y_del_punto_de_gauss ',int2str(pg)];
               case 'T5'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  f_VerifInfoGraf(elem,'elemento',c_TextTipoEjeGraf{iEje},iGraf);
                  ...
                  set = m_SetElem(elem);
                  elem = e_DatSet(set).m_NumElem(e_DatSet(set).m_IndElemSet==elem);
                  c_TextoEjes{iEje} = ['VelocidadFiltracion_T5_del_elemento ',int2str(elem),...
                     ' y_del_punto_de_gauss ',int2str(pg)];
               case 'chi'
                  elem = m_DatGrafXY(iGraf,iEje+2);
                  f_VerifInfoGraf(elem,'elemento',c_TextTipoEjeGraf{iEje},iGraf);
