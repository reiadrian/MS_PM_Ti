...
% /media/lamec/Adrián/Multiscale_PorousMedia_uTpP/Ejemplos/RVE_1_FOE
TEST_DATA(1).path_file= [main_example_path '/Ejemplos/RVE_01_FOE_Ti/']; TEST_DATA(1).file = 'Macro.mfl' ;
