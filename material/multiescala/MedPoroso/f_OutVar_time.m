...
function e_VarEst_new = f_OutVar_time(e_VarEst_new,e_VarEst_old,...
            ...
            sigmaT_new,mflu_new,velflu_sta,velflu_total,velflu_new,velflu_dyn,T3,T4,T5,velflu_n1,e_VG,flag)
...
if e_VG.conshyp == 50 || e_VG.conshyp == 60 || e_VG.conshyp == 61
...
%     e_VarEst_new.velflu = (velflu_total/theta)-((1-theta)*e_VarEst_old.velflu/theta);
    e_VarEst_new.velflu_sta = velflu_sta; 
    e_VarEst_new.velflu_n1 = velflu_n1;
    e_VarEst_new.velflu_dyn= velflu_dyn;
    e_VarEst_new.T3= T3;
    e_VarEst_new.T4= T4;
    e_VarEst_new.T5=T5;
